...
<div class="card mb-3">
    ...
    <div class="card-body text-center">
      ...
      <p>By. <a href="/posts?author={{ $posts[0]->author->username }}" style="text-decoration: none">{{ $posts[0]->author->name }}</a> in <a href="/posts?category={{ $posts[0]->category->slug }}" style="text-decoration: none">{{ $posts[0]->category->name }}</a> {{ $posts[0]->created_at->diffForHumans() }}</p>
      </small>
